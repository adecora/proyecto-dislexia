# word2speech: Generación Digital de Audio Adaptativo para la Dislexia

Es una herramienta de línea de comandos (CLI) diseñada para la generación automatizada de material sonoro de alta calidad a través del uso de varios modelos de síntesis de voz (TTS, Text-to-Speech).
